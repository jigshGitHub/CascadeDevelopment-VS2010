...
ko.bindingHandlers['dataTable'] = {
    'init': function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
        ...
        // Define the sDom binding
        if (binding.sDom) {
            options.sDom = binding.sDom;
        }

        //Define the pagination binding
        ...
        if (!options.fnRowCallback) {
            options.fnRowCallback = function (row, srcData, displayIndex, displayIndexFull) {
                ...
                ko.utils.arrayForEach(columns, function (column) {
                    ...
                    if (typeof (column.bVisible) != 'undefined' && !column.bVisible) {
                        // Create a new cell.
                        var newCell = $('<td style="display: none;"></td>');
