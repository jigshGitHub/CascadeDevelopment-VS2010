...
namespace Cascade.Data.Repositories
{
    ...
    {
        private CascadeDBEntities dbContext;
        ...
        protected SqlConnection GetConnection()
        {
            ...
            {
                mCN = ConfigurationManager.ConnectionStrings["ApplicationServices"].ToString();
        ...
        {
            dbContext = (CascadeDBEntities)UnitOfWorkStore.GetInstance("DBEntities");
            if (dbContext == null)
            {
